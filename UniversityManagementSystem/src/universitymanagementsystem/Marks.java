...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String enrollno) {
        ...
        JLabel heading = new JLabel("Gujarat Technology University");
        ...
        JLabel lblrollno = new JLabel("Enroll Number " + enrollno);
        ...
        try {
            ...
            ResultSet rs1 = c.s.executeQuery("select * from subject where Enno = '"+enrollno+"'");
            while(rs1.next()) {
            ...
            ResultSet rs2 = c.s.executeQuery("select * from marks where Enno = '"+enrollno+"'");
            while(rs2.next()) {
