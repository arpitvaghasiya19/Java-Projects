...
//        add(image);
        ...
        JLabel lblenrollnumber = new JLabel("Select Enroll Number");
        lblenrollnumber.setBounds(50, 70, 150, 20);
        add(lblenrollnumber);
        
        cenrollno = new Choice();
        cenrollno.setBounds(200, 70, 150, 20);
        add(cenrollno);
        ...
        try {
            ...
            while(rs.next()) {
                cenrollno.add(rs.getString("Enno"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            try {
                ...
                String query1 = "insert into subject values('"+cenrollno.getSelectedItem()+"', '"+cbsemester.getSelectedItem()+"', '"+tfsub1.getText()+"', '"+tfsub2.getText()+"', '"+tfsub3.getText()+"', '"+tfsub4.getText()+"', '"+tfsub5.getText()+"')";
                String query2 = "insert into marks values('"+cenrollno.getSelectedItem()+"', '"+cbsemester.getSelectedItem()+"', '"+tfmarks1.getText()+"', '"+tfmarks2.getText()+"', '"+tfmarks3.getText()+"', '"+tfmarks4.getText()+"', '"+tfmarks5.getText()+"')";
