...
public class TeacherLeave extends JFrame implements ActionListener{
    ...
    TeacherLeave(){
        ...
        JLabel lblenno = new JLabel("Search by Employee Id");
        lblenno.setFont(new Font("tamoha",Font.PLAIN,19));
        lblenno.setBounds(60,100,250,20);
        add(lblenno);

        choiceemp = new Choice();
        choiceemp.setBounds(60,130,250,20);
        add(choiceemp);
    ...
    public void actionPerformed(ActionEvent e) {
       if(e.getSource() == submit){
           ...
           String query = "insert into teacherleave values('"+empid+"', '"+date+"', '"+dduration+"')";
